  ...
  return (
    (<DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-neutral-100 text-neutral-500 hover:bg-neutral-900 hover:text-neutral-50 focus:bg-neutral-200 focus:text-neutral-500 dark:bg-neutral-50 dark:text-neutral-900 dark:hover:bg-neutral-50 dark:hover:text-neutral-900 dark:focus:bg-neutral-50 dark:focus:text-neutral-900",
