...
const CompCalendar = () =>{
    ...
    <Calendar
      ...
      selected={date}
      onSelect={setDate}
      className="flex justify-center rounded-lg shadow-md mt-5 bg-black w-2/6 text-white"
    />
    </div>
    </>
  )
