...
const AskAi = () => {
    ...
    Your name is jimmy.\
    Whenever a user greets you just introduce yourself and greet them back in one sentence only.\
    ...
    Make sure to use markdown to render the response in a webpage including table formatting, emojies, relevant links and spacing.\
            ...
            <Card className="lg:w-3/5 mx-auto h-full">
                ...
                <CardContent>
                    <form onSubmit={getResponseFromAi}>
                        ...
                        <Input className="my-2" type='text' name="question" value={value} onInput={handleChange} placeholder='Ask AI anything' required />
                ...
                <CardContent>
                    ...
                    <div className='grid grid-cols-5 gap-1'>
                        <div className='col-span-3 bg-green-500 p-1 opacity-80 text-white rounded-full border border-green-300 flex items-center pl-5 text-sm'>
                            <NotebookPen className='mr-1 h-5' /> Prepare a meal plan for me
                        </div>
                        <div className='col-span-3 bg-red-500 p-1 opacity-80 text-white rounded-full border border-red-300 flex items-center pl-5 text-sm'>
                            <HandHeart className='mr-1 h-5' /> Help me with my workout routine
                        </div>
                        <div className='col-span-3 bg-blue-500 p-1 opacity-80 text-white rounded-full border border-blue-300 flex items-center pl-5 text-sm'>
